  ...
  return (
    <nav className="topbar" aria-label="顶部导航">
      <NavLink className="brand" to="/" aria-label="StudyPlan 首页">
        <span className="brand-mark" aria-hidden="true">
          ...
          >
            ...
            <path
              d="M18 17.5c0-2 1.6-3.5 3.5-3.5H45c2.2 0 4 1.8 4 4v31.5c0 1.4-1.1 2.5-2.5 2.5h-25A3.5 3.5 0 0 1 18 48.5v-31Z"
              fill="#172033"
              opacity=".18"
            />
            <path
              d="M16 16.5c0-2 1.6-3.5 3.5-3.5H43c2.2 0 4 1.8 4 4v31.5c0 1.4-1.1 2.5-2.5 2.5h-25A3.5 3.5 0 0 1 16 47.5v-31Z"
              fill="url(#page)"
            />
            <path
              d="M23 21h17M23 29h17M23 37h10"
              stroke="#4361ee"
              stroke-width="4"
              stroke-linecap="round"
            />
            <path
              d="m35.5 42.5 4.5 4.5 10-12"
              fill="none"
              stroke="#0fbc9d"
              stroke-width="5"
              stroke-linecap="round"
      ...
      <div className="api-config" aria-label="服务配置">
        ...
        />
        <button className="button ghost" type="button" onClick={saveApiBase}>
          保存
        </button>
      </div>
    </nav>
